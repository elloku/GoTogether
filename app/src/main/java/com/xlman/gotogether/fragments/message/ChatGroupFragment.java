package com.xlman.gotogether.fragments.message;
...
import com.xlman.factory.presenter.message.ChatContract;
import com.xlman.factory.presenter.message.ChatGroupPresenter;
import com.xlman.gotogether.R;
import com.xlman.gotogether.activities.CarPoolingMemberActivity;
...
/**
 * create by xlman on 18:47 2018/2/14
 */
    ...
    public void onInitGroupMembers(List<MemberUserModel> members, long moreCount) {
        ...
        if (moreCount > 0) {
            ...
            mMemberMore.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // mReceiverId 就是群的Id
                    CarPoolingMemberActivity.show(getContext(), mReceiverId);
                }
            });
        } else {
            ...
            mToolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem item) {
                    if (item.getItemId() == R.id.action_add) {
                        // mReceiverId 就是群的Id
                        CarPoolingMemberActivity.showAdmin(getContext(), mReceiverId );
                        return true;
                    }
                    return false;
                }
